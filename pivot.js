...
(function() {
  var $, PivotData, addCommas, aggregatorTemplates, aggregators, assemblePartialTotalsKey, convertToArray, dayNames, deriveAttributes, derivers, forEachRecord, getPivotData, mthNames, numberFormat, pivotTableRenderer, renderers, spanSize, zeroPad,
    __slice = [].slice,
  ...
  */
  ...
  assemblePartialTotalsKey = function(key1, key2) {
    return (!key1 || key1 === "" ? "0" : key1) + "|" + (!key2 || key2 === "" ? "0" : key2);
  };
  ...
  aggregatorTemplates = {
    ...
    partialFractionOf: function(wrapped, type) {
      if (type == null) {
        type = "total";
      }
      return function() {
        ...
        return function(data, rowKey, colKey) {
          return {
            ...
            value: function() {
              ...
              rowSubTotal = data.partialRowTotalsMap[key] ? data.partialRowTotalsMap[key] : data.getAggregator.apply(data, this.selector).inner.value();
              return this.inner.value() / rowSubTotal;
            }
          };
        };
      };
  ...
  */
  ...
  PivotData = (function() {
    ...
    PivotData.prototype.processRecord = function(record) {
      var colKey, flatColKey, flatRowKey, partialTotalsKey, rowKey, x;
      colKey = (function() {
      ...
      if (partialTotalsKey in this.partialRowTotalsMap) {
        this.partialRowTotalsMap[partialTotalsKey]++;
      } else {
        this.partialRowTotalsMap[partialTotalsKey] = 1;
      }
  ...
  */
  ...
  $.fn.pivotUI = function(input, inputOpts, overwrite) {
    var aggregator, axisValues, c, colList, defaults, existingOpts, i, k, opts, pivotTable, refresh, renderer, rendererControl, shownAttributes, tblCols, tr1, tr2, uiTable, x, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
      _this = this;
    if (overwrite == null) {
      overwrite = false;
    }
    ...
    _fn = function(c) {
      var btns, colLabel, filterItem, keys, v, valueList, _j, _len1, _ref2;
      keys = (function() {
        var _results;
        _results = [];
    ...
    refresh = function() {
      ...
      return _this.data("pivotUIOptions", {
        cols: subopts.cols,
        rows: subopts.rows,
        vals: vals,
